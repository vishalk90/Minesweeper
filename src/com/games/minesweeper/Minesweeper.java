...
public class Minesweeper {
	...
	public static void main(String[] args) {
		 ...
		 * (bomb[i][j]) System.out.print("@ "); else System.out.print(". "); }
		 * System.out.println();
		 * 
		 * }
		 */
		...
		while (flag) {
			...
			if (xx <= x && yy <= y && xx > 0 && yy > 0) {
				...
				for (int k = 0; k < 4; k++) {
					...
					/*
					 * System.out.println("Value of K =" + k); for (int i1 = 1;
					 * i1 < disp.length - 1; i1++) { for (int j1 = 1; j1 <
					 * disp.length - 1; j1++) { if (disp[i1][j1] < 0)
				...
				if (BombCounter == BlockCounter) {
					flag = false;					
				}
				System.out.println("=================================");

			} else
				System.out.println("Try again with proper values..");
			// System.out.println();

		}

		if (flag == false && (BombCounter != BlockCounter)) {
		...
		} else if (BombCounter == BlockCounter) {
			//System.out.println("-------------------------------");
